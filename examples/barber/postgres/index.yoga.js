...
import { createHTTPMCPHandler } from '@simtlix/simfinity-mcp';
...
const mcpHandler = await createHTTPMCPHandler(schema, {
...
app.get('/health', (_req, res) => res.json({ status: 'ok', database: 'postgresql' }));
